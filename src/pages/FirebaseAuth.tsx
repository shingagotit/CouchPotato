...
import FirebaseRegisterForm from '@/components/auth/FirebaseRegisterForm';
import FirebasePasswordResetForm from '@/components/auth/FirebasePasswordResetForm';
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6">
        <div className="bg-card/80 backdrop-blur-strong border border-border rounded-2xl shadow-card p-8">
          ...
          {currentView === 'password-reset' && (
            <FirebasePasswordResetForm onBackToLogin={handleSwitchToLogin} />
          )}
        ...
        <div className="text-center mt-8 text-muted-foreground text-sm">
          ...
          <p className="mt-1 text-xs">Secured with Firebase Authentication</p>
        </div>
      </div>
    </div>
  );
